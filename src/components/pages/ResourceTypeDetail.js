...
const ResourceTypeDetail = () => {
  ...
  const navigate = useNavigate("");
  useEffect(() => {
    axios.get(`/api/resourceType/${id}`).then((response) => {
  ...
  const editHandler = (e) => {
    ...
    axios.patch(`/api/resourceType/detail/${id}`, newDetails).then(() => {
      alert("Resource Type Details Updated Successfully");
        ...
        >
          <form onSubmit={editHandler}>
            <FormControl isRequired>
              <FormLabel htmlFor="name">Resource Type Name</FormLabel>
              <Input
                id="name"
